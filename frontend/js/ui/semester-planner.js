...
const SemesterPlannerUI = {
    ...
    renderConflicts: (conflicts) => {
        ...
        if (errorConflicts.length > 0) {
            ...
            html += '<h4 style="margin: 0 0 10px 0; color: #d32f2f; font-size: 14px;">⚠ Errors</h4>';
        ...
        if (warningConflicts.length > 0) {
            ...
            html += '<h4 style="margin: 0 0 10px 0; color: #f57c00; font-size: 14px;">⚠ Warnings</h4>';
        ...
        if (infoConflicts.length > 0) {
            ...
            html += '<h4 style="margin: 0 0 10px 0; color: #1976d2; font-size: 14px;">ⓘ Information</h4>';
    ...
    renderOverallCompetencies: (semesterData, allCompetencies) => {
        ...
        let html = allCompetencies.map(comp => {
            ...
            return `
                <div style="background: #ffffff; border-left: 4px solid ${statusColor}; border-radius: 6px; padding: 12px;">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div style="font-weight: 600; color: #2c3e50; font-size: 14px;">${comp.name}</div>
    ...
    renderPerSemesterBreakdown: (semesterData, allCompetencies) => {
        ...
        let html = semesterData.map(sd => {
            ...
            return `
                <div style="background: #ffffff; border-radius: 8px; padding: 15px; border: 2px solid #ddd;">
